...
// Category titles here MATCH the Help-center categories (HELP_CATS) so the Help
// page can deep-link straight to a FAQ section by slug (see Help.jsx → /faqs?cat=).
export const FAQ_GROUPS = [
  {
    ...
    items: [
      ...
      ['How do I apply a promo code?', 'Enter your code in the promo field on the booking card before you pay — a valid code applies the discount to your order total instantly.'],
      ...
      ['Where is my receipt?', 'Your receipt and invoice are in Order history under your account, and a copy is emailed to you when payment succeeds.'],
    ],
  },
  {
    cat: 'Using your tickets',
    items: [
      ['Where do I find my QR code?', 'Go to My tickets in your account. Each ticket has a unique QR code that’s scanned at the door.'],
      ...
      ['How do I add an event to my calendar?', 'Open the ticket and tap Add to calendar to download an .ics file that works with Google, Apple and Outlook calendars.'],
    ],
  },
  {
    cat: 'Refunds & changes',
    items: [
      ...
      ['How do I request a refund?', 'Open Order history, select the relevant order and choose Request refund. You can also email support@obs.events with your order number.'],
      ['How long do refunds take?', 'Approved refunds are returned to your original payment method within 5–7 business days.'],
      ['What if an event is cancelled?', 'If an organizer cancels, you’re refunded in full automatically, including the service fee. No action needed.'],
      ['Can I change the attendee details?', 'Yes — update the attendee name from the ticket detail screen up to 24 hours before the event, subject to the organizer’s settings.'],
    ],
  },
  {
    ...
    items: [
      ...
      ['How does member pricing work?', 'When you’re a member of an event’s chapter, member prices and members-only events unlock automatically at checkout.'],
  ...
  },
  {
    cat: 'For organizers',
    items: [
      ['How do I list an event?', 'Apply to become an organizer, then use the 6-step event wizard to create and submit your event. It goes live once approved.'],
      ['How do I manage attendees?', 'Open your event in the organizer workspace to view registrations, check attendees in with the scanner, and export the guest list.'],
      ['When do I get paid out?', 'Payouts are settled to your connected account after the event, minus the platform fee. Track them under Payouts.'],
    ],
  },
  {
    cat: 'Account & privacy',
    items: [
      ['How do I reset my password?', 'Use Forgot password on the sign-in screen and we’ll email you a secure reset link.'],
      ['How is my data handled?', 'We only collect what’s needed to run your account and bookings. See our Privacy policy for the full detail.'],
      ['How do I manage notifications?', 'Update your email and notification preferences from your account settings at any time.'],
    ],
  },
];
...
export const HELP_CATS = [
  ...
  ['👥', 'Chapters & membership', 'Membership and benefits', ['Join a chapter', 'Member pricing explained', 'Start a chapter']],
